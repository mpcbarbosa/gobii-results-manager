...
$payload = @{
    ...
    activity = @{
        title = "ExpansÃ£o empresarial identificada"
        notes = "Empresa anunciou: Nova fÃ¡brica em SetÃºbal`nImpacto ERP: Alto - necessidade de novo mÃ³dulo logÃ­stico`nFonte: https://example.com/expansion/123"
        meta = @{
